...
AI_CONTROL_REQUIRED_TEXT = [
    ...
    "No live, certified, production, supported, endorsed, or partner integration is claimed",
...
PT_AI_CONTROL_REQUIRED_TEXT = [
    ...
    "não reivindica integração em direto, certificada, em produção, suportada, endossada ou de parceria",
